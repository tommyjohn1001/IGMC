#!/bin/bash -e
#SBATCH --job-name=L2
#SBATCH --output=/lustre/scratch/client/vinai/users/hoanglh88/IGMC/slurms/May17_L2.out
#SBATCH --error=/lustre/scratch/client/vinai/users/hoanglh88/IGMC/slurms/May17_L2.err
...
srun --container-image=/lustre/scratch/client/vinai/users/hoanglh88/utils/dc-miniconda3-py:38-4.10.3-cuda11.4.2-cudnn8-ubuntu20.04.sqsh \
     ...
     python bot.py --scenario  1 -g 0 --metric L2 --mixer trans_encoder --dataset yahoo_music --mode coop &\
     python bot.py --scenario  2 -g 1 --metric L2 --mixer trans_encoder --dataset yahoo_music --mode coop &\
     python bot.py --scenario  3 -g 2 --metric L2 --mixer trans_encoder --dataset yahoo_music --mode coop &\
     python bot.py --scenario  4 -g 3 --metric L2 --mixer trans_encoder --dataset yahoo_music --mode coop &\
     python bot.py --scenario  5 -g 0 --metric L2 --mixer trans_encoder --dataset yahoo_music --mode coop &\
     ...
     python bot.py --scenario  3 -g 2 --metric L2 --mixer trans_encoder --dataset flixster --mode coop &\
     python bot.py --scenario  4 -g 3 --metric L2 --mixer trans_encoder --dataset flixster --mode coop &\
